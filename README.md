...
6. Additional data can be collected for these cities from other webpages like:. Since there was no particular usecase for this dataset, []() , []() have been scrapped for demonstration.
